...
const ReuseableCard = ({heading, paragraph, imageUrl}) => {
  return (
    <div className='flex xl:w-[1169px] h-[546px] gap-11 items-center xl:px-[171px] m-auto shadow-md z-10 hover:scale-110 hover:bg-[#feeeed]  transition-all duration-300 px-10 flex-col my-28 xl:flex-row xl:my-0 '>
